...
<body>
<h1 align="center" style="color:#94ba65" >Listagem de Categorias</h1>
<table id="tabela" width="100%" border="1" bgcolor="gainsboro">
    <tr>
    <th style="color:#94ba65; font-size:20px">Excluir</th>
        <th style="color:#94ba65">Id</th>
        <th style="color:#94ba65">Descrição / Editar</th>
...
<br>
<br>
<center><a href="/categoria/form"><button style="height: 85px; width:350px; font-size:25px; background-color:#2790b0;border: 1 solid black;" >Adicionar mais categorias</button></a></center>
