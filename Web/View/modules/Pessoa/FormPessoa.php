...
<body>
    <form action="/pessoa/save" method="post">
        <fieldset>
        <br>    
        <legend style="color: #94ba65;">Cadastro de Pessoa</legend>
    ...
    <br>
    <center><a href="/pessoa"><button style="height: 85px; width:350px; font-size:25px; background-color:#2790b0;border: 1 solid black;" >Ver listagem de pessoas</button></a></center>
